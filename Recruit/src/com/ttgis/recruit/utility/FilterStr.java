...
public class FilterStr {
	 ...
	 * @return
	 */
	public static String FilterHtmlImg(String inputString) {
		...
		try {
			...
			String regEx_img = "<\\s*img\\s+([^>]*)\\s*>"; // 定义HTML标签的正则表达式
			...
			htmlStr = htmlStr.replaceAll("<\\s*img\\s+([^>]*)\\s*>", "[图片]");
