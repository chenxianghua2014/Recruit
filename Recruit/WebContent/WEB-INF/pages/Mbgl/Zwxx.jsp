...
<body>
	<div class="title">当前位置:模板管理>职位信息模板</div>
	<div class="editBlock">
		<table>
			<tbody>
				<tr>
					<td height="32" colspan="4" class="subtitle">职位信息模板查询</td>
				</tr>
				<tr>
					<td width="150"><input name="button" type="button"
						class="inputButton" value="添加" onclick="AddMbgl('职位信息')" />
					</td>
					<td style="text-align:right;">模版名称:<input name="keywords"
