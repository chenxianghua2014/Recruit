...
<body>
	<form action="SaveMbgl" method="post" autocomplete="off"
		...
		<div class="title">当前位置:模板管理>编辑消息通知模板</div>
		<input name="mbglId" type="hidden" class="mbglId" id="mbglId"
			value="${ mbgl.mbglId}" />
		<div class="editBlock">
			<table>
				<tbody>
					<tr>
						<td height="32" colspan="2" class="subtitle">编辑消息通知模板</td>
					</tr>
					<tr>
						<th width="150"><span class="warning">*</span>通知类型:</th>
						<td><select id="mbglType" name="mbglType"
							data-rule="required;" style="width:120px;">
								<option value="测评通知">测评通知</option>
								<option value="面试通知">面试通知</option>
								<option value="面试圈通知">面试圈通知</option>
								<option value="录用通知">录用通知</option>
								<option value="淘汰通知">淘汰通知</option>
						</select></td>
					</tr>
					<tr>
