...
<script type="text/javascript" src="js/Tlq.js"></script>
</head>
  </head>
  
  <body>
  <div class="title">当前位置:内容管理及审核>讨论区管理</div> 
    <div class="editBlock">
		<table>
			<tbody>
				<tr>
				...
				<tr>
				   <td style="text-align: left;"><input name="button"
						type="button" class="inputButton" value="添加" onclick="javascript:tlqAdd();"/>
					</td>
					<td align="right">名称：<input name="tlqName" type="text" class="inputText"
						id="tlqName" />
					<input name="button"
