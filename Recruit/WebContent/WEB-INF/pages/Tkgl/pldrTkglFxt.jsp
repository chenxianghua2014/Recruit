...
<body>
<div class="title">当前位置:测评>分析题题库管理>批量导入</div>
	<div class="editBlock">
		...
		<table>
				...
				<tr>
					...
					<td>
						...
						<p class ="excelModel">5、<a href="<%=path%>/excelModel/TkglFxtModel.xls">资料分析题（小题）导入格式.xls</a></p>
					</td>
				</tr>
				<tr>
					<th></th>
					<td>
					<input class="inputButton" type="button" value="导入" onclick="importTkglFxt();">
					<input class="inputButton" type="button" value="返回" onclick="window.location.href='TkglFxt'">
					</td>
				</tr>
		</table>
	</form>
