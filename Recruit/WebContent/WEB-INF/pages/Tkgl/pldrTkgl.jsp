...
<body>
<div class="title">当前位置:测评>综合题题库管理>四选项批量导入</div>
	<div class="editBlock">
	<form enctype="multipart/form-data" name="ff" id="ff">
		<table>
				...
				<tr>
					<th>具体要求：</th>
					<td>
						<span style="color: red;">四选项试题导入！</span>
						<p>
							1、请按模板要求填写。<br /> 2、Excel文件中不能存在公式。<br />
							3、每次最多导入999行，文件大小限制在1M以内。<br /> 4、导入速度和每次导入的数据量有关，请耐心等待。
						</p>
						<p class ="excelModel">5、<a href="<%=path%>/excelModel/FourChooseTkgl.xls">四选项试题导入格式.xls</a></p>
					</td>
				</tr>
				<tr>
					<th></th>
					<td>
					<input class="inputButton" type="button" value="导入" onclick="importTkgl();">
