...
<script type="text/javascript" language="javascript">
	...
	function CountDown() {
		if (maxtime >= 0) {
			...
			document.ff.action = "GlgEngSubmit";
	...
	<div class="conRight">
		<div class="questions">
			<form name="ff" id="ff">
				...
				<table width="100%">
					<c:forEach items="${ glgEngList['qjyy'] }" var="map"
						varStatus="status">
						<tr>
					...
					<c:forEach items="${ glgEngList['swxz'] }" var="map"
						varStatus="status">
						<tr>
							<td>${status.index+1}、</td>
							<td colspan="2">${fn:replace(map.tkglSttg, " src", rp)}</td>
					...
					<c:forEach items="${ glgEngList['xxpp'] }" var="map"
						varStatus="status">
						<tr>
							<td></td>
							<td colspan="2">${fn:replace(map.tkglSttg, " src", rp)}</td>
					...
					<c:forEach items="${ glgEngList['ydlj'] }" var="map"
						varStatus="status">
						<tr>
							<td></td>
							<td colspan="2">${fn:replace(map.tkglSttg, " src", rp)}</td>
						...
						<%
							int ydljNumSmall = 1;
						%>
						<c:forEach items="${ydljListFxt2}" var="emap" varStatus="estatus">
					...
					<c:forEach items="${ glgEngList['yydw1'] }" var="map"
						varStatus="status">
						<tr>
							<td></td>
							<td colspan="2">${fn:replace(map.tkglSttg, " src", rp)}</td>
						...
						<%
							int stfxtnum = 1;
						%>
						<c:forEach items="${yydwListFxt1}" var="emap" varStatus="estatus">
							<c:if test="${emap.stbh eq map.tkglStbh}">
								<tr>
									<td>(<%=stfxtnum++%>)、</td>
									<td colspan="2">${fn:replace(emap.sttg, " src", rp)}</td>
					...
					<c:forEach items="${ glgEngList['yydw2'] }" var="map"
						varStatus="status">
						<tr>
							<td></td>
							<td colspan="2">${fn:replace(map.tkglSttg, " src", rp)}</td>
						...
						<%
							int yydw2fxt = 1;
						%>
						<c:forEach items="${yydwListFxt2}" var="emap" varStatus="estatus">
							<c:if test="${emap.stbh eq map.tkglStbh}">
								<tr>
									<td>(<%=yydw2fxt++%>)、</td>
									<td colspan="2">${fn:replace(emap.sttg, " src", rp)}</td>
