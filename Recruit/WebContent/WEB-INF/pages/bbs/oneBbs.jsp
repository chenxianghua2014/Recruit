...
<script type="text/javascript" src="js/oneBbs.js"></script>
</head>
<body>
	         		     ...
	         		     <div class="publish" style="margin-top:30px;">
						            ...
						            <input type="hidden" name="bbsId" id="bbsId" value="${bbs.bbsId}"/>
						             <input type="hidden" name="username" id="username" value="${userLoginSession.userName}"/>
						           		...
						           		<div class="pubfb">
						                	<div class="pubright"><a href="javascript:void(0);"  onclick="qtReviewSave();">发表</a></div>
						                </div>
					                </form>
				         </div>
...
function qtReviewSave(){
	if($("#username").val() == null || $("#username").val() == ""){
		...
		if(editor.getContent('reviewNr') == ""){
			...
			document.ff.action="qtReviewSave";
