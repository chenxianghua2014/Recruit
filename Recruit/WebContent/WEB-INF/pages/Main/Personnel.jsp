	...
	<div class="wrap clr">
		<div class="menu">
			...
			<ul>
				...
				<li><a href="Personnel" style="color: #0046ae;">人才队伍</a>
				</li>
				<li><a href="Career">职业生涯</a>
				</li>
		...
		<div class="content">
			<div class="conTop">
				<span>您的当前位置：首页 >> 员工发展 >>人才队伍</span> <img src="images/tag04.png" />&nbsp;
				<strong>人才队伍</strong> Talent Team
			</div>
