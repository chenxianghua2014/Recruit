	...
	<div class="wrap clr">
		<div class="menu">
			...
			<ul>
				...
				<li><a href="AboutMobile">关于移动</a>
				</li>
				<li><a href="Recruitment" style="color: #0046ae;">招聘</a>
				</li>
			</ul>
		</div>
		<div class="content">
			<div class="conTop">
				<span>您的当前位置：首页 >> 招聘指南 >> 招聘</span> <img src="images/tag04.png" />&nbsp;
				<strong>招聘</strong>Recruitment
			</div>
