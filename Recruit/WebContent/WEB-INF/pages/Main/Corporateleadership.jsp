...
<body>
	...
	<div class="wrap clr">
		<div class="menu">
			...
			<ul>
				<li><a href="GroupIntroduction">集团简介</a>
				</li>
				<li><a href="OfficialsAddress">领导致辞</a>
				</li>
				<li><a href="Corporateleadership" style="color:#0046ae;">企业领导</a>
				</li>
				<li><a href="Organization">组织机构</a>
				</li>
		...
		<div class="content">
			<div class="conTop">
				<span>您的当前位置：首页 >> 集团概况 >> 企业领导</span> <img src="images/tag04.png" />&nbsp;
				<strong>企业领导</strong>Corporate leadership
			</div>
