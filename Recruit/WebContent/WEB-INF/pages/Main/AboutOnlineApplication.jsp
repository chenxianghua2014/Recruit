...
<body>
	...
	<div class="wrap clr">
		<div class="menu">
			...
			<ul>
				<li><a href="AboutOnlineApplication" style="color: #0046ae;">关于网申</a>
				</li>
				<li><a href="AboutTheTest">关于约考</a>
				</li>
		...
		<div class="content">
			<div class="conTop">
				<span>您的当前位置：首页 >> 招聘指南 >> 关于网申</span> <img src="images/tag04.png" />&nbsp;
				<strong>关于网申</strong>About Online Application
			</div>
