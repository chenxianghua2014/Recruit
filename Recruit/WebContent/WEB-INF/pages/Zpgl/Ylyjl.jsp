...
<body>
	<div class="title">当前位置:招聘管理>已录用简历</div>
	<div class="editBlock">
		<table>
			<tbody>
				<tr>
					<td height="32" colspan="4" class="subtitle">已录用简历查询</td>
				</tr>
				<tr>
					<%--					<th width="150"></th>--%>
					<td style="text-align:right;">姓名:<input name="jtjlkName"
						type="text" class="inputText" id="jtjlkName" />&nbsp; 毕业院校:<input
						name="jtjlkByyx" type="text" class="inputText" id="jtjlkByyx" style="width:95px;" placeholder="请输入学校全称"/>&nbsp;
						专业:<input name="jtjlkZy" type="text" class="inputText"
						id="jtjlkZy" />&nbsp; 学历: <select name="jtjlkXl"
						class="inputText" id="jtjlkXl">
							<option value=""></option>
					...
					<input name="button" type="button" onclick="loadData();" class="inputButton" value="查询" />
						<input name="button" type="button" onclick="loadDataExp('录用');" class="inputButton" value="批量导出" />
					</td>
				</tr>
			</tbody>
		</table>
		...
		<table>
			...
			<thead>
				...
				<th width="30"><input id="checkAll" type="checkbox" /></th>
					...
					<th width="60" class="alignCenter">录用职位</th>
			...
			<tbody>
				<tr>
					<td colspan="2"><iframe src="" id="frmResult" name="frmResult"
						...
						name="Id" /><input type="hidden" id="UserId" name="UserId" />
					</td>
				</tr>
			</tbody>
		</table>
