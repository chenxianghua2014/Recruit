...
<body>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:right;">姓名:<input name="jtjlkName"
						...
						id="jtjlkZw" />&nbsp;职位类别: <select id="jtjlkGwlb"
						name="jtjlkGwlb">
							<option value=""></option>
			...
			<tbody>
				<tr>
					<td><input type="hidden" id="Id" name="Id" /><input
						type="hidden" id="jtjlkCpcj" name="jtjlkCpcj" /><input
						type="hidden" id="jtjlkCpjg" name="jtjlkCpjg" /><input
						type="hidden" id="jtjlkMszt" name="jtjlkMszt" /><input
						type="hidden" id="UserId" name="UserId" /><input type="hidden"
						id="jtjlkPositionId" name="jtjlkPositionId" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><span id="zw"></span><span id="tdApzw"><input
							name="button" type="button" onclick="Apzw('')" class="inputButton"
							value="安排职位" /> </span></td>
				</tr>
				<tr>
	...
	<div class="editBlock" id="divControllBatch" style="display: none;">
		<input type="hidden" id="Id" name="Id" /> <input type="hidden"
			...
			name="UserId" /> <input type="hidden" id="jtjlkPositionId"
			name="jtjlkPositionId" />
		<table>
			<tr>
			...
			<tbody>
				<tr>
					<td style="text-align: right;">安排职位：</td>
					<td><span id="zwBatch"></span> <span id="tdApzwBatch"><input
							name="button" type="button" onclick="Apzw('batch')" class="inputButton"
							value="安排职位" /></span></td>
				</tr>
				<tr>
					<td style="text-align: right;">进入测评环节：</td>
