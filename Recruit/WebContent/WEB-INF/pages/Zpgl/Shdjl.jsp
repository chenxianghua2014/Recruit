...
<script type="text/javascript" src="js/Shdjl.js"></script>
...
<body>
	<div class="title">当前位置:招聘管理>适合的简历</div>
	<div class="editBlock">
		<table>
			<tbody>
				<tr>
					<td height="32" colspan="4" class="subtitle">适合的简历查询</td>
				</tr>
				<tr>
					<%--					<th width="150"></th>--%>
					<td style="text-align:right;">姓名:<input name="jtjlkName"
						...
						class="inputButton" value="批量导出" />&nbsp;<input name="button"
						type="button" onclick="showBatch();" class="inputButton"
						value="批量操作" />
					</td>
				</tr>
			</tbody>
	...
	<div class="editBlock" id="divControll" style="display: none;">
		<table>
			...
			<tbody>
				<tr>
					<td style="text-align: right;"><input type="hidden" id="Id"
						name="Id" /> <input type="hidden" id="jtjlkCpcj" name="jtjlkCpcj" />
						<input type="hidden" id="jtjlkCpjg" name="jtjlkCpjg" /> <input
						type="hidden" id="jtjlkMszt" name="jtjlkMszt" /> <input
						type="hidden" id="UserId" name="UserId" /> <input type="hidden"
						id="jtjlkCzw" name="jtjlkCzw" /> <input type="hidden"
						id="jtjlkCzwId" name="jtjlkCzwId" />姓名：</td>
					<td id="name"></td>
				</tr>
				<tr>
					<td style="text-align: right;">进入测评环节：</td>
					<td><input name="button" type="button" onclick="Tzcp()"
						class="inputButton" value="通知测评" /></td>
				</tr>
				<tr>
					<td style="text-align: right;">进入面试环节：</td>
					<td><input name="button" type="button" onclick="Apms('')"
						class="inputButton" value="安排面试" /></td>
				</tr>
				<tr>
					<td style="text-align:right;">完成全部考试：</td>
					<td><input name="button" type="button" onclick="Ly();"
						class="inputButton" value="录用" />&nbsp; <input name="button"
						type="button" onclick="excute();" class="inputButton" value="淘汰" /></td>
				</tr>
			</tbody>
		</table>
	</div>
	<div class="editBlock" id="divControllBatch" style="display: none;">
		<input type="hidden" id="Ids" name="Ids" /> <input type="hidden"
			id="jtjlkCpcj" name="jtjlkCpcj" /> <input type="hidden"
			id="jtjlkCpjg" name="jtjlkCpjg" /> <input type="hidden"
			id="jtjlkMszt" name="jtjlkMszt" /> <input type="hidden" id="UserId"
			name="UserId" /> <input type="hidden" id="jtjlkCzw" name="jtjlkCzw" />
		<input type="hidden" id="jtjlkCzwId" name="jtjlkCzwId" />
		<table>
			<tr>
			...
			<tbody>
				<tr>
					<td style="text-align: right;">进入测评环节：</td>
					<td><input name="button" type="button" onclick="TzcpBatch()"
						class="inputButton" value="通知测评" /></td>
				</tr>
				<tr>
					<td style="text-align: right;">进入面试环节：</td>
					<td><input name="button" type="button" onclick="Apms('batch')"
						class="inputButton" value="安排面试" /></td>
				</tr>
				<tr>
					<td style="text-align:right;">完成全部考试：</td>
					<td><input name="button" type="button"
						onclick="excuteBatch('录用');" class="inputButton" value="录用" />&nbsp;
						<input name="button" type="button" onclick="excuteBatch('淘汰');"
						class="inputButton" value="淘汰" /></td>
				</tr>
			</tbody>
		</table>
	</div>
