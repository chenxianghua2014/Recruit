...
<body>
	<div class="title">当前位置:招聘管理>已淘汰简历</div>
	<div class="editBlock">
		<table>
			<tbody>
				<tr>
					<td height="32" colspan="4" class="subtitle">已淘汰简历查询</td>
				</tr>
				<tr>
					<td style="text-align:right;">姓名:<input name="jtjlkName"
						...
						type="button" onclick="loadData();" class="inputButton" value="查询" />&nbsp;<input
						name="button" type="button" onclick="loadDataExp('淘汰');"
		...
		<table>
			...
			<thead>
				<tr>
					...
					<th width="60" class="alignCenter">测评结果</th>
					<th width="60" class="alignCenter">标注/备注</th>
					<th width="60">投递时间</th>
					<th width="60" class="alignCenter">面试详情</th>
					<th width="60" class="alignCenter">测评详情</th>
			...
			<tbody>
				<tr>
					<td colspan="2"><iframe src="" id="frmResult" name="frmResult"
						...
						name="Id" /><input type="hidden" id="UserId" name="UserId" /></td>
				</tr>
			</tbody>
		</table>
	</div>
			...
			<tbody>
				<tr>
					<td style="text-align: center;" colspan="2">筛选结果： <input
						name="button" type="button" onclick="backUpBatch();"
						class="inputButton" value="恢复" />&nbsp;
					</td>
				</tr>
			</tbody>
		</table>
