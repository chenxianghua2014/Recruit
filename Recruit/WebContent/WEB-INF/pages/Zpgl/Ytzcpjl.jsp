...
<script type="text/javascript" src="js/Ytzcpjl.js"></script>
...
<body>
	<div class="title">当前位置:招聘管理>已通知测评简历</div>
	<div class="editBlock">
		<table>
			<tbody>
				<tr>
					<td height="32" colspan="4" class="subtitle">已通知测评简历查询</td>
				</tr>
				<tr>
					<%--					<th width="150"></th>--%>
		...
		<table>
			...
			<thead>
				<tr>
					...
					<th width="60" class="alignCenter">测评筛选</th>
				</tr>
			</thead>
	...
	<div class="editBlock" id="divControll" style="display: none;">
		<table>
			<tr>
				<td colspan="2" class="subtitle">测评详情</td>
			</tr>
			<tbody>
				<tr>
				...
				<tr>
					<td colspan="2"><input type="hidden" id="Id" name="Id" /><input
						...
						id="jtjlkCpcj" name="jtjlkCpcj" /> <iframe src="" id="frmCpcj"
							name="frmCpcj" width="100%" height="320" scrolling="auto"
