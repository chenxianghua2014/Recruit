...
<script type="text/javascript" src="js/Bdwjlk.js"></script>
...
<body>
	<div class="title">当前位置:招聘管理>本单位简历库</div>
	<div class="editBlock">
		<table>
			<tbody>
				<tr>
					<td height="32" colspan="4" class="subtitle">本单位简历库</td>
				</tr>
				<tr>
					<td style="text-align:right;">姓名:<input name="jtjlkName"
						...
						id="jtjlkHkd" /> &nbsp;招聘过程状态:
						<select id="jtjlkZt" name="jtjlkZt">
							<option value="未筛选,筛选协同,通过,未测评,已测评,已安排面试,测评,一面进行中,二面进行中,终面进行中,录用,淘汰">全部状态</option>
						...
						onclick="loadData();" class="inputButton" value="查询" />&nbsp;<input name="button" type="button" onclick="loadDataExp();"
						class="inputButton" value="导出Excel" /></td></td>
				</tr>
			</tbody>
		</table>
	</div>
