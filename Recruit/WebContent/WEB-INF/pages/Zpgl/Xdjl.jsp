...
<body>
	<div class="title">当前位置:招聘管理>新的简历</div>
	<div class="editBlock">
		<table>
			<tbody>
				<tr>
	...
	<div class="editBlock" id="divControll" style="display: none;">
		<table>
			...
			<tbody>
				<tr>
					<td style="text-align: right;width:50%;"><input type="hidden"
						id="Id" name="Id" /><input type="hidden" id="UserId"
						name="UserId" />姓名：</td>
				...
				<tr>
					<td style="text-align: center;" colspan="2">筛选结果：<input
						...
						value="淘汰" />&nbsp;<input name="button" type="button"
						onclick="window.location.href='Sxxt?id=' + $('#Id').val();"
						class="inputButton" value="筛选协同" />
					</td>
				</tr>
			</tbody>
		</table>
			...
			<tbody>
				<tr>
					<td style="text-align: center;" colspan="2">筛选结果： <input
						...
						<!-- <input name="button" type="button" onclick="window.location.href='Sxxt?id=' + $('#Id').val();" class="inputButton" value="筛选协同" /> -->
					</td>
				</tr>
			</tbody>
		</table>
