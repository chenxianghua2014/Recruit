...
<script type="text/javascript" src="js/XcxxCheck2.js"></script>
<script type="text/javascript" src="js/common.js"></script>
</head>
<body>
	<div class="title">当前位置:宣传信息>单位简介审核</div>
	<div class="editBlock">
		<table>
			<tbody>
				<tr>
					<td height="32" colspan="4" class="subtitle">简介信息管理</td>
				</tr>
				<tr>
					<th width="150"></th>
					<td style="text-align:right;">审核状态:<select id="xcxxCheckstatus"
						name="xcxxCheckstatus">
							<option value="">全部</option>
							<option value="待审核">待审核</option>
							<option value="已发布">已发布</option>
							<option value="不通过">不通过</option>
					</select>&nbsp;简介内容:<input name="keywords" type="text" class="inputText"
	...
	<div class="dataGrid">
		<table>
			...
			<thead>
				<tr>
					...
					<th width="110" class="alignCenter">审核</th>
				</tr>
			</thead>
		...
		<table class="page">
			<tr>
				<td style="text-align: right;"><div id="Pagination" class="pagination"></div></td>
