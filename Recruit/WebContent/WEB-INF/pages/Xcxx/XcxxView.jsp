...
<body>
	<div class="title">当前位置:宣传信息>单位简介管理>查看单位简介</div>
	<div class="editBlock">
		<form action="XcxxSava" method="post" autocomplete="off"
			...
			<table>
				<tr>
					<td colspan="2" class="subtitle">查看简介信息</td>
				</tr>
				<tbody>
					<tr>
						<th width="150"><span class="warning">*</span>简介类别</th>
						<td><select id="xcxxXclb" name="xcxxXclb"
							data-rule="required;" style="width: 142px;"
							onchange="bindXcnr(this.value)">
						</select></td>
					</tr>
					<tr style="display: none;">
						...
						<td><input type="hidden" id="imgSrc" name="imgSrc">&nbsp;<input
							...
							id="picResult" style="color: #339900;"></span></td>
					</tr>
					<tr style="display: none;">
						...
						<td><input type="hidden" id="movSrc" name="movSrc">&nbsp;<input
							...
							id="movResult" style="color: #339900;"></span></td>
					</tr>
					<tr>
						<th width="150"><span class="warning">*</span>简介内容</th>
						<td><select id="xcxxTitle" name="xcxxTitle"
							data-rule="required;" style="width: 142px;">
						</select></td>
					</tr>
					<tr>
