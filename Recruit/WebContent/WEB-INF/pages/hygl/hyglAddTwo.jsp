...
<div class="editBlock">
  ...
  <table>
  <tr>
  <th width="40%"><span class="warning">*</span>单位代码:</th>
  <td><input type="text" name="memberIdcard" value="${zzjg.zzjgDwdm}" dataType="Require"  msg="必填" />
    <input type="hidden" name="memberId" value="${member.memberId}"/>
    </td>
   </tr>
    <tr>
   <th width="40%"><span class="warning">*</span>单位名称:</th>
  <td>
  <input type="text" name="memberName" value="${zzjg.zzjgDwmc}" dataType="Require"  msg="必填" />
  </td>
  </tr>
   <tr>
