...
LiveValidation.prototype = {
	...
	initialize : function(D, C) {
		...
		var B = C || {};
		this.validMessage = B.validMessage || "正确!";
...
var Validate = {
	...
	Email : function(B, C) {
		var C = C || {};
		var A = C.failureMessage || "不是有效的Email!";
		Validate.Format(B, {
			failureMessage : A,
